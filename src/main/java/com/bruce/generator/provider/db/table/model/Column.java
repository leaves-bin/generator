package com.bruce.generator.provider.db.table.model;


import com.bruce.generator.provider.db.table.model.util.ColumnHelper;
import com.bruce.generator.util.GLogger;
import com.bruce.generator.util.StringHelper;
import com.bruce.generator.util.TestDataGenerator;
import com.bruce.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.bruce.generator.util.typemapping.DatabaseDataTypesUtils;
import com.bruce.generator.util.typemapping.JavaPrimitiveTypeMapping;
import com.bruce.generator.util.typemapping.JdbcType;
import com.bruce.generator.GeneratorProperties;
import com.bruce.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.bruce.generator.util.StringHelper;
...
//			_table.getExportedKeys().addForeignKey(refTable.getSqlName(), hasMany.columnSqlName, getSqlName(), hasMany.columnSqlName.toLowerCase().hashCode());
    ...
    private void initOtherProperties() {
        ...
        columnAlias = (getRemarks() == null || "".equals(getRemarks())) ? "" : ": " + StringHelper.removeCrlf(getRemarks());
