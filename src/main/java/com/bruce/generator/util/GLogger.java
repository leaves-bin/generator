package com.bruce.generator.util;
...
//            new Throwable().printStackTrace(out); //print call trace
	...
	public static void init_with_log4j_config() {
	    ...
	    logLevel = toLogLevel(props.getProperty("com.bruce.generator.util.GLogger","INFO"));
	    perfLogLevel = toLogLevel(props.getProperty("com.bruce.generator.util.GLogger.perf","ERROR"));
	}
