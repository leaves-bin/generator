...
import com.bruce.generator.Generator.GeneratorModel;
...
import com.bruce.generator.provider.java.model.JavaClass;
import com.bruce.generator.util.*;

import java.io.*;
import java.util.*;

import static com.bruce.generator.GeneratorConstants.DATABASE_TYPE;
import static com.bruce.generator.GeneratorConstants.GENERATOR_TOOLS_CLASS;
...
public class GeneratorFacade {
    ...
    public static List<Table> getAllTableNames() throws Exception {
     ...
     * com.bruce.generator.provider.db.table.model.Table
     * 
     * @throws Exception
     */
     ...
     * com.bruce.generator.provider.java.model.JavaClass
     */
    ...
    public static class GeneratorModelUtils {
        ...
        public static Map getShareVars() {
            ...
            templateModel.put(DATABASE_TYPE.code,
                    GeneratorProperties.getDatabaseType(DATABASE_TYPE.code));
    ...
    private static class PrintUtils {
        ...
        public static void printAllTableNames(List<Table> tables) throws Exception {
            ...
            for (int i = 0; i < tables.size(); i++) {
                ...
                String sqld = ((Table) tables.get(i)).getRemarks();
                GLogger.println(sqlName);
                GLogger.println(sqld);
            }
